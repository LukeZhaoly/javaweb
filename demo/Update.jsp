    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="ArticlesServlet?method=update&id=<%=Integer.parseInt(request.getParameter("id"))%>" method="post" >
                    <table class="insert-tab" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>作者：</th>
                                <td><input class="common-text" name="Publisher" size="50" value="" type="text"></td>
                            </tr>
                             <tr>
                                <th>评审状态：</th>
                                <td><input class="common-text" name="status" size="50" value="" type="text"></td>
                            </tr>
                            <tr>
                                <th>Comments：</th>
                                <td><textarea name="comments" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
